...
workbook1.download(__dirname + '/workbook1.xlsx').then(function () {
...
workbook2.download(__dirname + '/workbook2.xlsx').then(function () {
...
workbook3.download(__dirname + '/workbook3.xlsx').then(function () {
...
workbook4.download(__dirname + '/workbook4.xlsx').then(function () {
...
workbook5.download(__dirname + '/workbook5.xlsx').then(function () {
...
workbook6.download(__dirname + '/workbook6.xlsx').then(function () {
...
row7.set(['Greetings']);
workbook7.download(__dirname + '/workbook7.xlsx').then(function () {
...
workbook8.download(__dirname + '/workbook8.xlsx').then(function () {
...
workbook9.download(__dirname + '/workbook9.xlsx').then(function () {
...
workbook10.download(__dirname + '/workbook10.xlsx').then(function () {
...
workbook11.download(__dirname + '/workbook11.xlsx').then(function () {
...
workbook12.download(__dirname + '/workbook12.xlsx').then(function () {
